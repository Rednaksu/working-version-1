...
class selectedPlayersForGameSessionTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        activePlayers = realm.objects(Player.self).filter("inGameSession == true").count
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if playersInSession?[indexPath.row].inGameSession == true {
            
          //  var activePlayersTempTable:[String?] = [playersInSession?[indexPath.row].name]
