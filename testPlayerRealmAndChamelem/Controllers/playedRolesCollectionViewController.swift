//
//  playedRolesCollectionViewController.swift
...
private let reuseIdentifier = "playedRole"
...
class playedRolesCollectionViewController: UICollectionViewController {
var celz = playerLib?.count
